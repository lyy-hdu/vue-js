        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 与普通路由跳转不同，这里在加入购物车，进行路由跳转之前，发请求把你购买产品的信息通过请求的方式服务器，
                服务器进行存储 -->
...
export default {
  ...
  methods: {
    ...
    async addShopcart() {
      ...
      // 下面代码是在调用仓库中的addOrUpdateShopCart，这个方法加上async，返回一定是个promise
      // 要么成功要么失败
      // 2 需要知道这次请求是成功还是失败 如果成功进行路由跳转 如果失败给提示
      try {
        ...
        // 产品信息数据(比较复杂:skuInfo) 通过会话存储（不持久，会话结束消失）
        // 本地或会话存储 一般存储的是字符串
